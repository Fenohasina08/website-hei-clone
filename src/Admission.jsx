...
const Admission = () => {
  return (
    <div className="flex flex-col items-center justify-center w-screen mt-2 text-white bg-[#6586C7] h-[70vh]">
      ...
      <div className="flex flex-row justify-center bg-transparent w-full max-w-5xl h-[250px] m-8">
        ...
        <div className="flex w-full h-full overflow-hidden bg-yellow-300 rounded">
          {/* Card 1 */}
          <div className="w-1/3 p-6 text-left text-black bg-[#FCDFB5] card1">
          ...
          {/* Card 2 */}
          <div className="relative w-1/3 p-6 text-left text-black bg-[#F7D090] card2">
          ...
          {/* Card 3 */}
          <div className="w-1/3 p-6 text-left text-black bg-[#F1C16B] card3">
